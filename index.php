...
<footer id="rin-footer">
    <div>©2020-2021 Blue. | Made with love by Blue. | BG: <a href="https://cdn.jsdelivr.net/gh/U2SG/pp@main/">
	   <img class="badge" src="https://data.jsdelivr.com/v1/package/gh/U2SG/pp/badge"></a>
		</div>
</footer>
...
function uploadimg(file){
      ...
      var picurl="https://cdn.jsdelivr.net/gh/U2SG/pp@main/"+nameofimg;
    var settings = {
    "url": "https://api.github.com/repos//U2SG/pp/contents/"+nameofimg,
    "method": "PUT",
    "timeout": 0,
    "headers": {
        "Authorization": "Bearer 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",
